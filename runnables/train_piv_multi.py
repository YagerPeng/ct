...
def main(args: DictConfig):
    ...
    multimodel = instantiate(args.model.piv_multi, args, dataset_collection, _recursive_=False)
    if args.model.piv_multi.tune_hparams:
        multimodel.finetune(resources_per_trial=args.model.piv_multi.resources_per_trial)
    ...
    multimodel_trainer = Trainer(gpus=eval(str(args.exp.gpus)), logger=mlf_logger, max_epochs=args.exp.max_epochs,
                                 ...
                                 gradient_clip_val=args.model.piv_multi.max_grad_norm)
